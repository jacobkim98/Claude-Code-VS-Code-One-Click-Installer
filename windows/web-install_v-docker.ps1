# Claude Code Web Installer for Windows (with Docker)
# Usage: powershell -ep bypass -c "irm https://raw.githubusercontent.com/jacobkim98/Claude-Code-VS-Code-One-Click-Installer/main/windows/web-install_v-docker.ps1 | iex"

# Script URL for admin re-launch
$ScriptUrl = "https://raw.githubusercontent.com/jacobkim98/Claude-Code-VS-Code-One-Click-Installer/main/windows/web-install_v-docker.ps1"
